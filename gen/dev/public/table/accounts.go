...
type accountsTable struct {
	...
	DocumentNumber postgres.ColumnString
...
func newAccountsTableImpl(schemaName, tableName, alias string) accountsTable {
	var (
		...
		DocumentNumberColumn = postgres.StringColumn("document_number")
		CreatedAtColumn      = postgres.TimestampzColumn("created_at")
		UpdatedAtColumn      = postgres.TimestampzColumn("updated_at")
		allColumns           = postgres.ColumnList{IDColumn, DocumentNumberColumn, CreatedAtColumn, UpdatedAtColumn}
		mutableColumns       = postgres.ColumnList{DocumentNumberColumn, CreatedAtColumn, UpdatedAtColumn}
